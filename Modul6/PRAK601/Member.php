...
<div class="table-section">
    <table id="table">
        <tr class="header-row">
            <th class="header-item items">Nama Member</th>
            <th class="header-item items">Nomor Member</th>
            <th class="header-item items">Alamat</th>
            <th class="header-item items">Tanggal Mendaftar</th>
            <th class="header-item items">Tanggal Terakhir Bayar</th>
            <th class="header-item items">Tindakan</th>
        </tr>
        <?= showData("member") ?>
    </table>
    <br><a href="FormMember.php" class="button"><span>Tambah Member</span></a>
</div>
</body>
</html>